...
void __attribute__((picinterrupt(("")))) Ext_Counter(void)
{
...
void main()
{
    ...
    lcd_init();
    lcd_write(1,2,"INT EXTERNA");
    lcd_write(2,2,"Counter:");

    while(1)
    {
        _delay((unsigned long)((100)*(8000000/4000.0)));
        sprintf(BufferLCD,"%01d ", counter);
        lcd_write(2,10,BufferLCD);
    }
}
